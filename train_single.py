"""
Train one (method, seed) combo on the hard tangram puzzle and save the best
...
def main():
    ap = argparse.ArgumentParser(description='Train one hard-tangram (method, seed) combo')
